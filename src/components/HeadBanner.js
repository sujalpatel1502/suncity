    ...
    return (
        ...
        <div className='max-lg: w-full max-w-[1224px] flex items-center justify-between'>
         ...
         <div className="hidden max-lg:block basis-1/2 text-right py-2 navmenubar items-center justify-center">
          ...
          <div className='rounded-full transition duration-500 ease-in-out bg-[#DEDEDE] w-10 h-10 flex items-center justify-center hover:bg-[#87AB42] transform hover:mb-2 cursor-pointer hover:-translate-y-1 hover:scale-110 '>
          ...
          <LuPhoneCall size={30} color='rgb(241 121 41)'/>
         ...
         <div className=' hidden lg:flex w-[1px] h-14 bg-gray-400'>
         </div>
