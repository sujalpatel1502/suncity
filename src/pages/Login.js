  ...
  return (
    <div class="py-16">
      <div class="flex bg-white rounded-lg shadow-lg  overflow-hidden mx-auto max-w-sm lg:max-w-4xl border">
        <div
          class="hidden lg:block lg:w-1/2 bg-cover justify-center items-center self-center"

          // style={{
          //   background: `url(${"https://images.unsplash.com/photo-1546514714-df0ccc50d7bf?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=667&q=80"})`,
          // }}
        >
          <Lottie options={defaultOptions} height={400} width={400} />
        </div>
        <div class="w-full p-8 lg:w-1/2">
          <div className="hidden lg:block cursor-pointer h-[100px] w-[350px] flex justify-start items-center">
            <img
              src={require("../assets/SUNCITYLOGO.png")}
              className="max-lg:h-16 object-fit"
            />
          </div>
          <p class="text-xl text-gray-600 text-center mt-4">Welcome back!</p>
          <a
            href="#"
